...
const images = [
  { src: '/images/ingresso-castello.webp', alt: 'Ingresso del Castello di Carlo V Crotone' },
  { src: '/images/ponte-di-pietra-scaled.webp', alt: 'Ponte di pietra del castello' },
  { src: '/images/ponte-di-pietra-vista-ingresso.webp', alt: "Vista del ponte di pietra verso l'ingresso" },
  { src: '/images/ponte-pietra-2.webp', alt: 'Ponte di pietra, vista laterale' },
  { src: '/images/torre-comandante.webp', alt: 'Torre Comandante del castello' },
  { src: '/images/torre-aiutante.webp', alt: 'Torre Aiutante del castello' },
  { src: '/images/cortina.webp', alt: 'Cortina muraria del castello' },
  { src: '/images/cortina-bastione.webp', alt: 'Bastione e cortina del castello' },
  { src: '/images/foto-torre-comandante.webp', alt: 'Torre Comandante vista frontale' },
